 ...
 * @author Chantal Roth
 */
public class ScoreDistributionPanel extends javax.swing.JPanel {
    ...
    boolean interactive;
    private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(ScoreDistributionPanel.class);
    /**
    ...
    private void recreateChart() {
        ...
        if (distributions == null || distributions.length < 1) {
            if (interactive) {
                JOptionPane.showMessageDialog(this, "I got no flow signal distribution data at position " + this.location);
            } else {
                err("I got no flow signal distribution data at position " + this.location);
            }
            return;
        }
        if (chartpanel != null) {
...
//        transform.translate(-6, 6);
    ...
    private void doSaveImageAction() {
        ...
        try {
            ...
            Logger.getLogger(ScoreDistributionPanel.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
