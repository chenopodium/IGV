...
import org.broad.igv.feature.tribble.DagCodec;
...
public class DagParser implements FeatureParser {

    static Logger log = Logger.getLogger(DagParser.class);

    private TrackProperties trackProperties = null;

    public DagParser(String path) {
    }
    ...
    public List<org.broad.tribble.Feature> loadFeatures(BufferedReader reader, Genome genome) {
        ...
        String line = null;
        int lineNumber = 0;
        DagCodec codec = new DagCodec(genome);
        try {
    ...
    public static void main(String[] args) throws IOException {
       String file = "E:\\git\\igvs\\testdata1\\test.dag";
    }
}
