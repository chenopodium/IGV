...
public class PreferencesEditor extends javax.swing.JDialog {
        ...
        //======== tabbedPane ========
        {
            ...
            //======== panel5 ========
            {
                ...
                //======== panel6 ========
                {
                    ...
                    binSizeText.setBounds(135, 55, 80, 15);
                    ...
                    panel6.add(label29);
                    label29.setBounds(new Rectangle(new Point(10, 75), label29.getPreferredSize()));
                    ...
                    radioLine.setBounds(new Rectangle(new Point(135, 75), radioLine.getPreferredSize()));
                    ...
                    radioArea.setBounds(new Rectangle(new Point(135, 100), radioArea.getPreferredSize()));
                    ...
                    panel6.add(radioBar);
                    radioBar.setBounds(new Rectangle(new Point(135, 125), radioBar.getPreferredSize()));
                    ...
                    radioStacked.setBounds(new Rectangle(new Point(135, 150), radioStacked.getPreferredSize()));
                ...
                //======== panel7 ========
                {
                    ...
                    textServer.setBounds(155, 20, 255, textServer.getPreferredSize().height);
            ...
            //======== jPanel13 ========
            {
                ...
                jPanel13.add(label27);
                label27.setBounds(5, 5, 100, label27.getPreferredSize().height);
                ...
                { // compute preferred size
                    ...
                    preferredSize.width += insets.right;
                    preferredSize.height += insets.bottom;
                    jPanel13.setMinimumSize(preferredSize);
                    jPanel13.setPreferredSize(preferredSize);
                }
            }
            tabbedPane.addTab("text", jPanel13);
   ...
   * */
    ...
    // Generated using JFormDesigner Evaluation license - Chantal Roth
