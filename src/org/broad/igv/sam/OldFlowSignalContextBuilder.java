 ...
 */
public class OldFlowSignalContextBuilder {
    ...
    public OldFlowSignalContextBuilder(boolean show, float[] oldSignals, float[] flowSignals, String flowOrder, int flowOrderStart,
